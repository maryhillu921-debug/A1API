...
```bash
curl -X POST "https://apia1.com/api/v1/chat/completions" -H "Authorization: Bearer <APIA1_API_KEY>" -H "Content-Type: application/json" -d '{"model":"openai/gpt-4o","messages":[{"role":"user","content":"Привет"}]}'
```
